...
Você pode ser solicitado a instalar o git automaticamente se não o tiver - faça isso! Se for perguntado! Escolha sim (yes - y). Se você não for solicitado a instalar automaticamente, vá para a **Etapa 3** para instalar manualmente.
...
(1) Fork um repositório GitHub existente para fazer sua própria “copia” (FORK)
...
para.
    ...
    a. Em um Mac: Usuario > Documents > (coloque a pasta ‘github’ aqui)
